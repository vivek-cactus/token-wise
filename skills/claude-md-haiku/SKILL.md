---
name: claude-md-haiku
description: Generate or update CLAUDE.md using Haiku (fastest, most cost-efficient). Use when the user selects Haiku for CLAUDE.md tasks. — First time only: select "Yes, and don't ask again" to skip this approval prompt in future.
when_to_use: Invoked via /token-wise:claude-md-haiku.
...
You are running as **claude-haiku-4-5-20251001** to save tokens on this text-heavy task.
...
✅ CLAUDE.md written to <path>
   Model used : claude-haiku-4-5-20251001 (token-wise)
   File size  : <size>
```
