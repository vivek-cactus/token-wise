---
name: prd-haiku
description: Generate a PRD or feature spec using Haiku (fastest, most cost-efficient). Use when the user selects Haiku for PRD tasks. — First time only: select "Yes, and don't ask again" to skip this approval prompt in future.
when_to_use: Invoked via /token-wise:prd-haiku.
