---
name: readme-haiku
description: Generate or update a README using Haiku (fastest, most cost-efficient). Use when the user selects Haiku for README tasks. — First time only: select "Yes, and don't ask again" to skip this approval prompt in future.
when_to_use: Invoked via /token-wise:readme-haiku.
