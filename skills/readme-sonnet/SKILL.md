---
name: readme-sonnet
description: Generate or update a README using Sonnet (balanced quality and cost). Use when the user selects Sonnet for README tasks. — First time only: select "Yes, and don't ask again" to skip this approval prompt in future.
when_to_use: Invoked via /token-wise:readme-sonnet.
